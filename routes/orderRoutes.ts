...
import { sendOrderNotification } from '../config/mail.js';
...
router.post('/', async (req: Request, res: Response) => {
  try {
    ...
    // Gửi thông báo email cho admin (không làm gián đoạn phản hồi của khách)
    sendOrderNotification(savedOrder).catch(err => console.error('Lỗi gửi mail thông báo:', err));
